						...
						<v-col cols="4" class="serviceCol ">
							...
							<div class="serviceItemDiv">
								...
								<div class="inline" v-if="form.attendees > 1">
									<v-tooltip right color="#1e1e1e" max-width="8vw">
										...
										<span class="tooltip"
											>Must sell all slots before start date or session will be canceled</span
										>
									</v-tooltip>
								</div>
							</div>
							...
							<div class="serviceItemDiv">
								<v-tooltip right max-width="14vw" color="#333333">
									...
									<span>
										List of required software or games needed to complete the service ie. Discord,
										Minecraft</span
									>
								</v-tooltip>
						...
						<v-col cols="4" class=" serviceCol">
							...
							<div v-if="!serviceLoading">
								...
								<v-btn
									...
									:disabled="
										!descriptionValid || !valid || !serviceNameValid || form.terms.length === 0
									"
									class="btnCTA"
			...
			<v-card class="sessionDialogCard">
				<v-tabs v-model="termsTab" vertical hide-slider active-class="termsTabActive" class="termsTab">
					...
					<v-tab-item value="terms" id="terms">
						...
						<h1 v-else class="termsFontDefault"> You must have at least 1 term for your service.</h1>
						<v-form v-model="termsValid" ref="serviceForm" @submit.prevent>
							<v-text-field
								hide-details
								label="Add term"
								class=" termsInput"
								...
								v-model="term"
							>
								<v-icon slot="append" @click="addTerm"> fas fa-paper-plane </v-icon>
							</v-text-field>
						</v-form>
					</v-tab-item>
				</v-tabs>
