			...
			<v-sheet class="calSheet" height="23.6vw" color="transparent">
				...
				<v-dialog v-model="deleteDialog" width="500">
					<v-card>
						...
						<v-card-text>
							To confirm you want to delete this session please type the name of the session exactly into
							the form to enable the delete button.
						...
						<v-card-actions>
							...
							<v-btn
								color="primary"
								:disabled="deleteString !== selectedEvent.name"
								@click="deleteBooked"
							>
								Delete
							</v-btn>
